...
- Запрос рейтинга (`RatingRequestEvent`) &mdash; игрок запрашивает рейтинг всех игроков.
- Запрос SSL-сертификата (`SSLCertificateRequestEvent`) &mdash; клиент запрашивает SSL-сертификат сервера.
...
## SSLCertificateRequestEvent

**Клиент -> Сервер**: ничего

```json
{
  "type": "SSLCertificateRequestEvent"
}
```
